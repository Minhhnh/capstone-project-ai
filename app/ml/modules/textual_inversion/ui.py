...
import app.ml.modules.textual_inversion.preprocess
from app.ml.modules import sd_hijack, shared
...
def train_embedding(*args):
    ...
    try:
        ...
        embedding, filename = modules.textual_inversion.textual_inversion.train_embedding(
            *args)
